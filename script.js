...
async function loadVideos() {
  ...
  try {
    ...
    alert(
      "Couldn't load videos. Local videos loaded instead."
    );
  }
}
...
function renderVideos(list = videos) {
  ...
  list.forEach(video => {
    ...
    /*
      IMPORTANT:
      Show real video thumbnail
      when a video URL exists.
    */
